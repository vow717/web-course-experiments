...
<jsp:useBean id="teacher" scope="request" type="com.experiment6.entity.Teacher"/>
<jsp:useBean id="titles" scope="request" type="java.util.List<com.experiment6.entity.Title>"/>
<jsp:useBean id="courses" scope="request" type="java.util.List<com.experiment6.entity.Course>"/>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
<form action="experiment6/updateteacher" method="post">
